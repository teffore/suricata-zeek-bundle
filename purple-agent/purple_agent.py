...
# ============================================================================
#  MITRE ATT&CK lookup table + constants + enrichment helpers
#  (moved to purple_agent_pkg.enrich for testability; re-exported here for
#  backward compatibility with anything importing from this module.)
# ============================================================================

from purple_agent_pkg.enrich import (  # noqa: E402
    MITRE_LOOKUP,
    TACTIC_SEVERITY,
    NOISE_FLOOR_SIDS,
    KEV_PROBES,
